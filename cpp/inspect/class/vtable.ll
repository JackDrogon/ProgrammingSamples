...
define i32 @main() #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN7DerivedC1Ei(%struct.Derived* %2, i32 10)
...
11:                                               ; preds = %0
  store i32 0, i32* %1, align 4
  call void @_ZN7DerivedD1Ev(%struct.Derived* %2) #4
...
define linkonce_odr void @_ZN7DerivedC1Ei(%struct.Derived* %0, i32 %1) unnamed_addr #1 align 2 {
  ...
  call void @_ZN7DerivedC2Ei(%struct.Derived* %5, i32 %6)
  ret void
}
declare i32 @__gxx_personality_v0(...)
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN7DerivedD1Ev(%struct.Derived* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Derived*, align 8
  store %struct.Derived* %0, %struct.Derived** %2, align 8
  %3 = load %struct.Derived*, %struct.Derived** %2, align 8
  call void @_ZN7DerivedD2Ev(%struct.Derived* %3) #4
  ret void
}
; Function Attrs: noinline optnone ssp uwtable
define linkonce_odr void @_ZN7DerivedC2Ei(%struct.Derived* %0, i32 %1) unnamed_addr #1 align 2 {
  %3 = alloca %struct.Derived*, align 8
  %4 = alloca i32, align 4
  store %struct.Derived* %0, %struct.Derived** %3, align 8
  store i32 %1, i32* %4, align 4
  ...
  call void @_ZN4BaseC2Ei(%struct.Base* %6, i32 %7)
  %8 = bitcast %struct.Derived* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTV7Derived, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %8, align 8
  ret void
}
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN4BaseC2Ei(%struct.Base* %0, i32 %1) unnamed_addr #2 align 2 {
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTV4Base, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %6, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN7DerivedD0Ev(%struct.Derived* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Derived*, align 8
  store %struct.Derived* %0, %struct.Derived** %2, align 8
  %3 = load %struct.Derived*, %struct.Derived** %2, align 8
  call void @_ZN7DerivedD1Ev(%struct.Derived* %3) #4
  %4 = bitcast %struct.Derived* %3 to i8*
  call void @_ZdlPv(i8* %4) #5
  ret void
}
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr i32 @_ZN7Derived3getEv(%struct.Derived* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Derived*, align 8
  store %struct.Derived* %0, %struct.Derived** %2, align 8
  %3 = load %struct.Derived*, %struct.Derived** %2, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN4BaseD1Ev(%struct.Base* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Base*, align 8
  store %struct.Base* %0, %struct.Base** %2, align 8
  %3 = load %struct.Base*, %struct.Base** %2, align 8
  call void @_ZN4BaseD2Ev(%struct.Base* %3) #4
  ret void
}
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN4BaseD0Ev(%struct.Base* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Base*, align 8
  store %struct.Base* %0, %struct.Base** %2, align 8
  %3 = load %struct.Base*, %struct.Base** %2, align 8
  call void @_ZN4BaseD1Ev(%struct.Base* %3) #4
  %4 = bitcast %struct.Base* %3 to i8*
  call void @_ZdlPv(i8* %4) #5
  ret void
}
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr i32 @_ZN4Base3getEv(%struct.Base* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Base*, align 8
  store %struct.Base* %0, %struct.Base** %2, align 8
  %3 = load %struct.Base*, %struct.Base** %2, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN4BaseD2Ev(%struct.Base* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Base*, align 8
  store %struct.Base* %0, %struct.Base** %2, align 8
  %3 = load %struct.Base*, %struct.Base** %2, align 8
  ret void
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZN7DerivedD2Ev(%struct.Derived* %0) unnamed_addr #2 align 2 {
  %2 = alloca %struct.Derived*, align 8
  store %struct.Derived* %0, %struct.Derived** %2, align 8
  %3 = load %struct.Derived*, %struct.Derived** %2, align 8
  %4 = bitcast %struct.Derived* %3 to %struct.Base*
  call void @_ZN4BaseD2Ev(%struct.Base* %4) #4
  ret void
}
