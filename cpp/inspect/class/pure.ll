...
@_ZTV4Base = linkonce_odr unnamed_addr constant { [5 x i8*] } { [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI4Base to i8*), i8* bitcast (void (%struct.Base*)* @_ZN4BaseD1Ev to i8*), i8* bitcast (void (%struct.Base*)* @_ZN4BaseD0Ev to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*)] }, align 8

; Function Attrs: ssp uwtable mustprogress
define dso_local i32 @_Z3getP4Base(%struct.Base* %0) local_unnamed_addr #0 {
...
define dso_local i32 @main() local_unnamed_addr #1 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZN7DerivedC1Ei(%struct.Derived* nonnull dereferenceable(12) %1, i32 10)
  %3 = bitcast %struct.Derived* %1 to %struct.Base*
  %4 = invoke i32 @_Z3getP4Base(%struct.Base* nonnull %3)
          to label %5 unwind label %6

5:                                                ; preds = %0
  call void @_ZN7DerivedD1Ev(%struct.Derived* nonnull dereferenceable(12) %1) #11
...
define linkonce_odr void @_ZN7DerivedC1Ei(%struct.Derived* nonnull dereferenceable(12) %0, i32 %1) unnamed_addr #3 align 2 {
  call void @_ZN7DerivedC2Ei(%struct.Derived* nonnull dereferenceable(12) %0, i32 %1)
  ret void
}
...
define linkonce_odr void @_ZN7DerivedD1Ev(%struct.Derived* nonnull dereferenceable(12) %0) unnamed_addr #4 align 2 {
  call void @_ZN7DerivedD2Ev(%struct.Derived* nonnull dereferenceable(12) %0) #11
  ret void
}
...
; Function Attrs: ssp uwtable willreturn
define linkonce_odr void @_ZN7DerivedC2Ei(%struct.Derived* nonnull dereferenceable(12) %0, i32 %1) unnamed_addr #3 align 2 {
  %3 = bitcast %struct.Derived* %0 to %struct.Base*
  call void @_ZN4BaseC2Ei(%struct.Base* nonnull dereferenceable(12) %3, i32 %1)
  %4 = getelementptr inbounds %struct.Derived, %struct.Derived* %0, i64 0, i32 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTV7Derived, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %4, align 8, !tbaa !3
  ret void
}

; Function Attrs: nounwind ssp uwtable willreturn
define linkonce_odr void @_ZN4BaseC2Ei(%struct.Base* nonnull dereferenceable(12) %0, i32 %1) unnamed_addr #5 align 2 {
  %3 = getelementptr inbounds %struct.Base, %struct.Base* %0, i64 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTV4Base, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !tbaa !3
...
define linkonce_odr void @_ZN7DerivedD0Ev(%struct.Derived* nonnull dereferenceable(12) %0) unnamed_addr #6 align 2 {
  call void @_ZN7DerivedD1Ev(%struct.Derived* nonnull dereferenceable(12) %0) #11
...
define linkonce_odr i32 @_ZN7Derived3getEv(%struct.Derived* nonnull dereferenceable(12) %0) unnamed_addr #7 align 2 {
...
define linkonce_odr void @_ZN4BaseD1Ev(%struct.Base* nonnull dereferenceable(12) %0) unnamed_addr #8 align 2 {
  call void @llvm.trap() #13
  unreachable
}

; Function Attrs: nounwind ssp uwtable
define linkonce_odr void @_ZN4BaseD0Ev(%struct.Base* nonnull dereferenceable(12) %0) unnamed_addr #8 align 2 {
  call void @llvm.trap() #13
  unreachable
}
...
; Function Attrs: inlinehint nounwind ssp uwtable willreturn
define linkonce_odr void @_ZN7DerivedD2Ev(%struct.Derived* nonnull dereferenceable(12) %0) unnamed_addr #4 align 2 {
  %2 = bitcast %struct.Derived* %0 to %struct.Base*
  call void @_ZN4BaseD2Ev(%struct.Base* nonnull dereferenceable(12) %2) #11
  ret void
}

; Function Attrs: nounwind ssp uwtable willreturn
define linkonce_odr void @_ZN4BaseD2Ev(%struct.Base* nonnull dereferenceable(12) %0) unnamed_addr #5 align 2 {
  ret void
}
