...
public:
	...
	void register_callback(
	    function<void(::google::protobuf::Message *)> callback)
	{
...
private:
	map<const ::google::protobuf::Descriptor *,
	    function<void(::google::protobuf::Message *)>>
	    callbacks_;
};
...
void DealFoo(::google::protobuf::Message *m)
{
	...
	cout << "hello_world::foo => id: " << msg->id()
	     << ", str:" << msg->str() << ", opt:" << msg->opt() << endl;
}

void DealBar(::google::protobuf::Message *m)
{
	hello_world::bar *msg = static_cast<hello_world::bar *>(m);
	cout << "hello_world::bar => age: " << msg->age()
	     << ", name:" << msg->name() << endl;
}

::google::protobuf::Message *create_message(const string &type_name,
					    const string &s)
{
